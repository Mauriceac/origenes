...
const jsonDir = path.join(__dirname, '../docs/san-juan-crisostomo/in-epistulam-ad-romanos');
...
function generateMarkdown(jsonFilename) {
  ...
  const title = baseName.replace(/chapter_/, 'Homilía ');
  return `---\ntitle: ${title}\n---\n\nimport Content from '@site/docs/san-juan-crisostomo/in-epistulam-ad-romanos/${baseName}.json';\nimport Display, {generateTOC} from '@site/src/components/ChapterDisplay.js';\n\n<Display data={Content} />\n\nexport const toc = [\n  ...generateTOC(Content)\n]\n`;
}
